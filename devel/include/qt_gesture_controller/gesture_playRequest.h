...
bool operator==(const ::qt_gesture_controller::gesture_playRequest_<ContainerAllocator1> & lhs, const ::qt_gesture_controller::gesture_playRequest_<ContainerAllocator2> & rhs)
{
