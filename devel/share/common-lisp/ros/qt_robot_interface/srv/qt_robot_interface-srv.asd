...
(defsystem "qt_robot_interface-srv"
  ...
  :components ((:file "_package")
    ...
    (:file "setting_download" :depends-on ("_package_setting_download"))
    (:file "_package_setting_download" :depends-on ("_package"))
    (:file "setting_info" :depends-on ("_package_setting_info"))
    (:file "_package_setting_info" :depends-on ("_package"))
    (:file "setting_setVolume" :depends-on ("_package_setting_setVolume"))
    (:file "_package_setting_setVolume" :depends-on ("_package"))
    (:file "setting_upload" :depends-on ("_package_setting_upload"))
    (:file "_package_setting_upload" :depends-on ("_package"))
