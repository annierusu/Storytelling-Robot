...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<set_control_mode-request>)))
  ...
  (cl:format cl:nil "# constants~%uint8 M_ON=0~%uint8 M_OFF=1~%uint8 M_BREAK=2~%~%# an array of robot parts and/or single joint name (e.g. ['left_arm', 'right_arm', 'HeadPitch'])~%string[] parts~%uint8  mode~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'set_control_mode-request)))
  "Returns full string definition for message of type 'set_control_mode-request"
  (cl:format cl:nil "# constants~%uint8 M_ON=0~%uint8 M_OFF=1~%uint8 M_BREAK=2~%~%# an array of robot parts and/or single joint name (e.g. ['left_arm', 'right_arm', 'HeadPitch'])~%string[] parts~%uint8  mode~%~%~%"))
